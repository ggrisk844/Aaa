...
import { SchoolInfo, Teacher, Staff as StaffType, Student, Event, Notice, GalleryItem } from '../types';
...
export const Students = () => {
  ...
  const uniqueClassOptions = Array.from(new Set(classOptions)).sort((a: any, b: any) => {
